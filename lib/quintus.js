  ...
  */
  Q.setup = function(id, options) {
    ...
    if(!Q.el) {
      ...
      if(typeof options.width === 'number') { Q.el.width = options.width; }
      if(typeof options.height === 'number') { Q.el.height = options.height; }
    }
    ...
    if(elParent && !Q.wrapper) {
      ...
      if ( typeof options.wrapper_css === 'undefined' || options.wrapper_css === true ) {
