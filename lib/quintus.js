...
// canvas context. Most of the game-specific functionality is in the 
...
var Quintus = function(opts) {
  ...
  // Pause the entire game by canceling the last frame. If you use setTimeout or
...
// Finally, add in the requestAnimationFrame shim, if necessary
(function() {
    var lastTime = 0;
