...
var Quintus = function Quintus(opts)  {
  ...
  //
  /** Includes one or more modules in Quintus
   *
   *  @method include
   *  @memberOf Quintus#
   *  @param {string|Array} mod - a list of modules to include.
   *
   *  @example
   *  // Use a string as examples
   *  var Q = Quintus().include("Input, Sprites")
   *  
   *  // Pass in modules directly as an array
   *  var Q = Quintus().include([ Quintus.Input, Quintus.Sprites ]);
   *
   *  
   */
  ...
  /** Turns anything you pass into it into an Array, splitting strings on Commas.
   *
   * @method _normalizeArg
   * @memberOf Quintus#
   *
   * @param {string|Array} arg - either a comma separate string or an Array
   */
  ...
  /** Extends a destination object with an optional source object
   *
   * @method _extend
   * @memberOf Quintus#
   *
   * @param {Object} dest - the destination object
   * @param {Object} [source] - the object to pull properties from
   */
  ...
  /** Add default properties onto an object only the key is undefined
   *
   * @method _defaults
   * @memberOf Quintus#
   *
