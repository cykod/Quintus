...
Quintus["2D"] = function(Q) {
  ...
  Q.component('viewport',{
    ...
    extend: {
      follow: function(sprite,directions,moveWith) {
        moveWith ? this.viewport.moveWith = true : this.viewport.moveWith = false;
    ...
    softCenterOn: function(x,y) {
      if(this.moveWith && this.following.p.landed >= 0) {
        this.entity.moveTo(this.x, (this.following.p.y - Q.height / 2 / this.scale) );
      }
      if(x !== void 0) {
