  ...
  Q.Evented.extend("TouchSystem",{
    ...
    normalizeTouch: function(touch,stage) {
      ...
      if(Q._isUndefined(canvasPosX) || Q._isUndefined(canvasPosY)) {
	    ...
	    var rect = Q.el.getBoundingClientRect();
      this.touchPos.p.ox = this.touchPos.p.px = (canvasPosX  - rect.left)/ Q.cssWidth * Q.width;
      this.touchPos.p.oy = this.touchPos.p.py = (canvasPosY - rect.top) / Q.cssHeight * Q.height;
