    ...
    loadTMX: function(dataAsset) {
      ...
      for(t = 0; t < tilesets.length; t++) {
        ...
        for(i = 0; i < tileProps.length; i++) {
          var id = tileProps[i].getAttribute("id");          
          ...
          for(j = 0; j < props.length; j++) {
            ...
            if(this.tileProperties[id] === undefined) {
              this.tileProperties[id] = {};
            }
            this.tileProperties[id][propName] = propValue;
          }
        }
      }
        ...
        for(i = 0; i < objects.length; i++) {
          ...
          if(Q[oType] !== undefined) {
            ...
            var s = this.insert(new Q[oType]({
              ...
              name: parseInt(objects[i].getAttribute("name")),
            ...
            console.log("No class defined for " + oType);
          }
        }
      }
    },
